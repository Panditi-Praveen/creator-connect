 ...
 * request. This is what lets the Project Service call the Profile Service with
 * the same JWT the client presented here — the Profile Service authenticates
 * every request, including its read endpoints, so without forwarding the call
 * would be rejected with {@code 401}.
 *
