...
/**
 * Centralized error handling for the whole Project Service.
 *
...
public class GlobalExceptionHandler {
    ...
    /**
     * Handles requests for a project that does not exist.
     *
    ...
    /**
     * Handles attempts to modify or delete a project owned by another user.
     *
     * @param ex      the thrown exception
     * @param request the originating HTTP request
     ...
     * (e.g. a non-UUID {@code id} in {@code /projects/{id}}).
     *
    ...
    /**
     * Handles constraint violations raised at flush time (e.g. a broken data
     * constraint).
     *
     * @param request the originating HTTP request
     ...
     * (e.g. a trailing-slash base path such as {@code /projects/}). Spring 6 no
