...
/**
 * Generic envelope wrapping every successful AI Service response.
 *
 * <p>Provides the same consistent JSON shape used across the platform:
 * <pre>
 * {
 *   "timestamp": "2026-08-17T12:00:00",
 *   "status": 200,
 *   "message": "Talent discovery completed",
 *   "data": { ... },
 *   "path": "/ai/discover"
 * }
 * </pre>
