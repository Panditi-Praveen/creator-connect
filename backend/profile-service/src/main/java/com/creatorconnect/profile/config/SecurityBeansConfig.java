     ...
     *
     * <p>Unlike the Auth Service (which must expose public register/login routes),
     * the Profile Service keeps <em>every</em> endpoint authenticated except the
     * infrastructure endpoints needed by the platform:
     * <ul>
